...
protected:
  ...
  void assertXEqualsAfter(AdaptiveTrackFacade &track,
                          const std::string &directions, int x) {
...
TEST_F(AdaptiveTrackTests,
       completeIfPushedUpBumpLimitConsecutiveTimesAtCeiling) {
  setStartingX(10);
  setCeiling(10);
  setBumpLimit(3);
  setFirstSequenceRunCount(999);
...
TEST_F(AdaptiveTrackTests,
       completeIfPushedUpBumpLimitConsecutiveTimesAtCeiling2) {
  setStartingX(5);
  setCeiling(7);
...
TEST_F(AdaptiveTrackTests,
       completeIfPushedDownBumpLimitConsecutiveTimesAtFloor) {
  setStartingX(-10);
  setFloor(-10);
  setBumpLimit(3);
  setFirstSequenceRunCount(999);
...
TEST_F(AdaptiveTrackTests,
       completeIfPushedDownBumpLimitConsecutiveTimesAtFloor2) {
  setStartingX(-5);
  setFloor(-7);
  setFirstSequenceStepSize(7 - 5);
  setFirstSequenceDown(1);
