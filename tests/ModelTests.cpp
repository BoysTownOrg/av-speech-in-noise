...
void initializeWithTargetReplacement(ModelImpl &model, const FixedLevelTest &test) {
...
void initializeWithTargetReplacementAndEyeTracking(ModelImpl &model, const FixedLevelTest &test) {
