...
void RecognitionTestModel_Internal::prepareMasker(const std::string &p) {
    throwInvalidAudioFileOnErrorLoading(
        &RecognitionTestModel_Internal::loadMaskerFile, p);
...
void RecognitionTestModel_Internal::setAudioDevices(const AudioSettings &p) {
    throwInvalidAudioDeviceOnErrorSettingDevice(
        &RecognitionTestModel_Internal::setAudioDevices_, p.audioDevice);
}
...
void RecognitionTestModel_Internal::fadeInComplete() { playTarget(); }

void RecognitionTestModel_Internal::playTarget() { targetPlayer->play(); }
...
int RecognitionTestModel_Internal::trialNumber() { return trialNumber_; }
}
